...
$form.innerHTML=`
    ...
    <div class="contact-form-loader none">
      <img src="../asset/loader.svg" alt="Cargando">
    </div>
...
function validationsForm() {
 ...
 $form.addEventListener("submit",(e)=>{
   //if (!e.target.matches(".contact-form")) return false
   e.preventDefault()
      alert("Enviando formulario")
      const $loader=d.querySelector(".contact-form-loader"),
      $response=d.querySelector(".contact-form-response")
      $loader.classList.remove("none")
      fetch("https://formsubmit.co/ajax/correoelectronicodestinadoarecibirloscorreos",//ejemplo:fsfsf@gdfd.ff
     { method:"POST",
...
setTimeout(()=>validationsForm(),100)//al estar dentro del set timeout se va a la pila de espera
//validationsForm()
 return $form
}